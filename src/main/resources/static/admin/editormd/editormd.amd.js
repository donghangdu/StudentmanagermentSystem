...
;(function(factory) {
     ...
     * @returns {Object} editormd     Backeditormd对象
     */
    ...
    editormd.prototype    = editormd.fn = {
         ...
         * @param   {String}   id            编辑器的ID
         * @param   {Object}   [options={}]  配置选项 Key/Value
         * @returns {editormd}               Backeditormd的实例对象
         */
         ...
         * @returns {dialog}          Back创建的dialog的jQuery实例对象
         */
        ...
        save : function() {
            ...
            var markedOptions = this.markedOptions = {
                ...
                breaks      : true,
                pedantic    : false,
                sanitize    : (settings.htmlDecode) ? false : true,  // off忽略HTML标签，即on识别HTML标签，默认为false
                smartLists  : true,
                smartypants : true
            };
         ...
         * 
         * @returns {Cursor}         Back一个光标Cursor对象
         */
         ...
         * getHTML (alias)
         * 
         * @returns {String}           Return html code BackHTML源码
         */
     ...
     * @returns {Renderer} markedRenderer  Backmarked的Renderer自定义对象
     */
     ...
     * @returns {Object}   tocContainer    BackToC列表容器层的jQuery对象元素
     */
     ...
     * @returns {String}   html          Back过滤的HTML
     */
     ...
     * @returns {Object}   div           BackjQuery对象元素
     */
    ...
    editormd.markdownToHTML = function(id, options) {
        ...
        var markedOptions = {
            ...
            breaks      : true,
            pedantic    : false,
            sanitize    : (settings.htmlDecode) ? false : true, // 是否忽略HTML标签，即是否onHTML标签解析，为了安全性，默认不on
            smartLists  : true,
            smartypants : true
        };
     ...
     * @returns {String} EventType                   Back事件类型名称
     */
     ...
     * @returns {String}   datefmt      Back格式化后的日期时间字符串
     */
