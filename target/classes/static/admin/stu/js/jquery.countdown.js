...
(function ($, window, document, undefined) {
    ...
    $.fn[pluginName] = function (options) {
        ...
        // Allow any js function (i.e. a function whose name isn't 'init' or doesn't start with an underscore)
        // to be called via the jQuery plugin, e.g. $(element).countDown('functionName', arg1, arg2).
            ...
            this.each(function () {
                ...
                // Tests that there's already a plugin instance and checks that the requested js method exists.
